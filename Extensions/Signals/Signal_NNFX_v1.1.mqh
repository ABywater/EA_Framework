...
class CSignal_NNFX_LowTF : public CSignalBase {
...
public: // Constructors/Destructors
	CSignal_NNFX_LowTF(int index=1)
					: CSignalBase()
					{ Init(index); } 	
	CSignal_NNFX_LowTF(string symbol, ENUM_TIMEFRAMES timeframe,
					int index=1)
...
int CSignal_NNFX_LowTF::Init(int index) {
...
void CSignal_NNFX_LowTF::UpdateSignal() {
	double price = 0;
//--- ALMA line
